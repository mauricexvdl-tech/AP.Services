...
describe("AlchemyGateway", () => {
    ...
    describe("API Key Mode", () => {
        ...
        it("should make RPC call with API key", async () => {
            ...
            vi.stubGlobal("fetch", vi.fn().mockResolvedValue(
                mockFetchResponse({ id: 1, jsonrpc: "2.0", result: mockResult })
            ));
        ...
        it("should handle RPC errors", async () => {
            ...
            await expect(gateway.rpcCall("invalid_method"))
        ...
        it("should handle HTTP errors", async () => {
            ...
            await expect(gateway.rpcCall("eth_blockNumber"))
    ...
    describe("Convenience Methods", () => {
        ...
        it("should call getBlockNumber", async () => {
            vi.stubGlobal("fetch", vi.fn().mockResolvedValue(
                mockFetchResponse({ id: 1, jsonrpc: "2.0", result: "0xabc" })
            ));
        ...
        it("should call getTokenBalances", async () => {
            ...
            vi.stubGlobal("fetch", vi.fn().mockResolvedValue(
                mockFetchResponse({ id: 1, jsonrpc: "2.0", result: mockBalances })
            ));
        ...
        it("should call getAssetTransfers", async () => {
            ...
            vi.stubGlobal("fetch", vi.fn().mockResolvedValue(
                mockFetchResponse({ id: 1, jsonrpc: "2.0", result: mockTransfers })
            ));
