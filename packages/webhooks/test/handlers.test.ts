...
import { parseWebhookPayload, createEventRouter, type EventHandlerMap, type AporiaEvent } from "../src/handlers";
...
function createMockPayload(eventName: string, args: any[]): any {
    const abiFragments: Record<string, string> = {
        BotRegistered: "event BotRegistered(bytes32 indexed botId, address indexed owner, string imageURI, uint8 tier)",
