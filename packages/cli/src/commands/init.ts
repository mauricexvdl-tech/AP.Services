...
export async function initCommand(): Promise<void> {
    ...
    if (answers.walletMode === "generate") {
        ...
        console.log(chalk.yellow(`   ⚠️  Save your private key securely. It will be stored in the config.`));
    } else {
    ...
    console.log(chalk.cyan("\n   Next: Run"), chalk.bold("aporia register"), chalk.cyan("to register your first bot.\n"));
}
